...
namespace ASGV.CodeMaid.Helpers
{
    ...
    public static class ExplicitInterfaceImplementationHelper
    {
        ...
        public static bool IsExplicitInterfaceImplementation(CodeEvent codeEvent)
        {
            ...
            string declaration = CodeElementHelper.GetEventDeclaration(codeEvent);
            string matchString = @"\." + codeEvent.Name;
        ...
        public static bool IsExplicitInterfaceImplementation(CodeFunction2 codeFunction)
        {
            ...
            // Otherwise, look for the element name with a preceding dot.
            string declaration = CodeElementHelper.GetMethodDeclaration(codeFunction);
            string matchString = @"\." + codeFunction.Name;
        ...
        public static bool IsExplicitInterfaceImplementation(CodeProperty codeProperty)
        {
            ...
            // Otherwise, look for the element name with a preceding dot.
            string declaration = CodeElementHelper.GetPropertyDeclaration(codeProperty);
            string matchString = @"\." + codeProperty.Name;
