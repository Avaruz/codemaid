...
namespace ASGV.CodeMaid.UnitTests.Helpers
{
  ...
  public class FileHeaderHelperTests
  {
    ...
    public void GetHeaderLengthLanguage(CodeLanguage language, string text)
    {
      ...
      Assert.That(headerLength > 0, Is.True, $"Expecting value > 0, found {headerLength}");
    }
    ...
    public void GetHeaderLengthLanguageWithWrongTags(CodeLanguage language, string text)
    {
      ...
      Assert.That(headerLength == 0, Is.True, $"Expecting 0, found {headerLength}");
    }
    ...
    public void GetHeaderLengthMultiLine(string text, string tagStart, string tagEnd)
    {
      ...
      Assert.That(headerLength == expectedLength, Is.True, $"Expecting {expectedLength}, found {headerLength}");
    }
    ...
    public void GetNbLinesToSkip(string patternToFind, string text, string limit, int expectedNbLines)
    {
      ...
      Assert.That(nbLines == expectedNbLines, Is.True, $"Expecting {expectedNbLines}, found {expectedNbLines}");
    }
  }
}