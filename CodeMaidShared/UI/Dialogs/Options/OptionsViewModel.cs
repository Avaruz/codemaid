...
using ASGV.CodeMaid.UI.Dialogs.Options.Cleaning;
using ASGV.CodeMaid.UI.Dialogs.Options.Collapsing;
using ASGV.CodeMaid.UI.Dialogs.Options.Digging;
using ASGV.CodeMaid.UI.Dialogs.Options.Finding;
using ASGV.CodeMaid.UI.Dialogs.Options.Formatting;
using ASGV.CodeMaid.UI.Dialogs.Options.General;
using ASGV.CodeMaid.UI.Dialogs.Options.Progressing;
using ASGV.CodeMaid.UI.Dialogs.Options.Reorganizing;
using ASGV.CodeMaid.UI.Dialogs.Options.Switching;
using ASGV.CodeMaid.UI.Dialogs.Options.ThirdParty;
using System;
    ...
    public class OptionsViewModel : Bindable
    {
        ...
        public IEnumerable<OptionsPageViewModel> Pages
        {
            ...
            set
            {
                if (_pages != value)
                {
                    foreach (OptionsPageViewModel oldPage in (_pages ?? []).Flatten())
                    {
                    ...
                    foreach (OptionsPageViewModel newPage in (_pages ?? []).Flatten())
                    {
        ...
        /// </summary>
        public DelegateCommand ExportCommand => _exportCommand ??= new DelegateCommand(OnExportCommandExecuted);
        ...
        private void OnExportCommandExecuted(object parameter)
        {
            ...
            string activeSettingsName = ActiveSettingsName;
        ...
        /// </summary>
        public DelegateCommand ImportCommand => _importCommand ??= new DelegateCommand(OnImportCommandExecuted);
        ...
        /// </summary>
        public DelegateCommand ResetToDefaultsCommand => _resetToDefaultsCommand ??= new DelegateCommand(OnResetToDefaultsCommandExecuted);
        ...
        {
            string activeSettingsName = ActiveSettingsName;
            MessageBoxResult result = MessageBox.Show(Resources.AreYouSureYouWantAll + activeSettingsName + Resources.OptionsViewModel_OnResetToDefaultsCommandExecuted_ToBeResetToTheirDefaults + Environment.NewLine + Environment.NewLine +
        ...
        /// </summary>
        public DelegateCommand SaveCommand => _saveCommand ??= new DelegateCommand(OnSaveCommandExecuted, OnSaveCommandCanExecute);
        ...
        private void Save()
        {
            foreach (OptionsPageViewModel optionsPageViewModel in Pages.Flatten())
            {
        ...
        /// </summary>
        public DelegateCommand CancelCommand => _cancelCommand ??= new DelegateCommand(OnCancelCommandExecuted);
        ...
        /// </summary>
        public DelegateCommand SwitchSettingsCommand => _switchSettingsCommand ??= new DelegateCommand(OnSwitchSettingsCommandExecuted, OnSwitchSettingsCommandCanExecute);
        ...
        private bool CheckToSavePendingChangesShouldCancelOperation()
        {
            if (HasChanges)
            {
                MessageBoxResult result = MessageBox.Show(Resources.YouHavePendingChangesDoYouWantToSaveThemBeforeContinuing,
