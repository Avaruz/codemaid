...
namespace ASGV.CodeMaid.Logic.Cleaning
{
    ...
    internal sealed class UsingStatementCleanupLogic
    {
        ...
        {
            return _instance ??= new UsingStatementCleanupLogic(package);
        }
        ...
        public void RemoveAndSortUsingStatements(TextDocument textDocument)
        {
            ...
            System.Collections.Generic.List<string> usingStatementsToReinsert = [.. _usingStatementsToReinsertWhenRemoved.Value.Where(usingStatement => TextDocumentHelper.FirstOrDefaultMatch(textDocument, string.Format(patternFormat, usingStatement)) != null)];
            ...
            usingStatementsToReinsert = [.. usingStatementsToReinsert.Where(usingStatement => TextDocumentHelper.FirstOrDefaultMatch(textDocument, string.Format(patternFormat, usingStatement)) == null)];
