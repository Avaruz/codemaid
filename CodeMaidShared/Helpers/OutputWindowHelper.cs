    ...
    internal static class OutputWindowHelper
    {
        ...
        private static IVsOutputWindowPane CodeMaidOutputWindowPane
        {
            get
            {
                ...
                return _codeMaidOutputWindowPane ??= GetCodeMaidOutputWindowPane();
            }
        }
        ...
        {
            string exceptionMessage = $"{message}: {ex}";
        ...
        {
            IVsOutputWindowPane outputWindowPane = CodeMaidOutputWindowPane;
            ThreadHelper.ThrowIfNotOnUIThread();
            if (outputWindowPane != null)
            {
                string outputMessage = $"[CodeMaid {category} {DateTime.Now:hh:mm:ss tt}] {message}{Environment.NewLine}";
