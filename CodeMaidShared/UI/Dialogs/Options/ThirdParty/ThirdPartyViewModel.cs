...
namespace ASGV.CodeMaid.UI.Dialogs.Options.ThirdParty
{
  /// <summary>
  ...
  public class ThirdPartyViewModel : OptionsPageViewModel
  {
    ...
    public bool IsEnabledUseJetBrainsReSharperCleanup
    {
      get
      {
        ThreadHelper.ThrowIfNotOnUIThread(); return _commandHelper.FindCommand("ReSharper_SilentCleanupCode") != null || _commandHelper.FindCommand("ReSharper.ReSharper_SilentCleanupCode") != null;
      }
    }
