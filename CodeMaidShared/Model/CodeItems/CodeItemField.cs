  ...
  public class CodeItemField : BaseCodeItemElement
  {
    ...
    public CodeItemField()
    {
      ...
      _isConstant = LazyTryDefault(
          ...
          {
            ThreadHelper.ThrowIfNotOnUIThread();
            return CodeVariable?.IsConstant == true && CodeVariable.ConstKind == vsCMConstKind.vsCMConstKindConst;
          });
      ...
      _isReadOnly = LazyTryDefault(
          () => { ThreadHelper.ThrowIfNotOnUIThread(); return CodeVariable?.IsConstant == true && CodeVariable.ConstKind == vsCMConstKind.vsCMConstKindReadOnly; });

      _IsStatic = LazyTryDefault(
          () => CodeVariable?.IsShared == true);
