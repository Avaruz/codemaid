...
namespace ASGV.CodeMaid.Model.CodeItems
{
    ...
    public abstract class BaseCodeItemElement : BaseCodeItem
    {
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            TextPoint startPoint = CodeElement.GetStartPoint();
            TextPoint endPoint = CodeElement.GetEndPoint();
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            string commentPrefix = CodeCommentHelper.GetCommentPrefix(originalPoint.Parent);
            EditPoint point = originalPoint.CreateEditPoint();
