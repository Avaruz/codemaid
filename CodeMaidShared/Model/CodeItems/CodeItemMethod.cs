    ...
    public class CodeItemMethod : BaseCodeItemElement, ICodeItemComplexity, ICodeItemParameters, IInterfaceItem
    {
        ...
        public CodeItemMethod()
        {
            ...
            _Access = LazyTryDefault(
                () =>
                {
                    ...
                    return CodeFunction != null && !(IsStatic && IsConstructor) && !IsExplicitInterfaceImplementation ? CodeFunction.Access : vsCMAccess.vsCMAccessPublic;
                });
            ...
            _isConstructor = LazyTryDefault(
                () => { ThreadHelper.ThrowIfNotOnUIThread(); return CodeFunction != null && CodeFunction.FunctionKind == vsCMFunction.vsCMFunctionConstructor; });

            _isDestructor = LazyTryDefault(
                () => { ThreadHelper.ThrowIfNotOnUIThread(); return CodeFunction != null && CodeFunction.FunctionKind == vsCMFunction.vsCMFunctionDestructor; });
        ...
        public override KindCodeItem Kind
        {
            get
            {
                ...
                return IsDestructor ? KindCodeItem.Destructor : KindCodeItem.Method;
            }
        }
        ...
        public override void LoadLazyInitializedValues()
        {
            ...
            int c = Complexity;
            bool ic = IsConstructor;
            bool id = IsDestructor;
            bool ieii = IsExplicitInterfaceImplementation;
            vsCMOverrideKind ok = OverrideKind;
