...
namespace ASGV.CodeMaid.UI.ToolWindows.Spade
{
  ...
  public partial class SpadeView
  {
    ...
    private void OnTreeViewItemKeyDown(object sender, KeyEventArgs e)
    {
      ...
      if (treeViewItem == null || Keyboard.Modifiers != ModifierKeys.None)
      {
        return;
      }
    ...
    private void OnTreeViewItemHeaderDragEvent(object sender, DragEventArgs e)
    {
      ...
      {
        BaseCodeItem baseCodeItem = targetTreeViewItem.DataContext as BaseCodeItem;
        IList<BaseCodeItem> codeItemsToMove = e.Data.GetData(typeof(IList<BaseCodeItem>)) as IList<BaseCodeItem>;

        if (baseCodeItem != null && codeItemsToMove?.Contains(baseCodeItem) == false &&
    ...
    {
      ICodeItemParent itemAsParent = item as ICodeItemParent;
      return itemAsParent != null && (itemAsParent.Children.Contains(baseItem) ||
