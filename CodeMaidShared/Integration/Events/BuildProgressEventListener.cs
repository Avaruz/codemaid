...
namespace ASGV.CodeMaid.Integration.Events
{
  /// <summary>
  ...
  internal sealed class BuildProgressEventListener : BaseEventListener
  {
    ...
    {
      _dispBuildEvents_OnBuildBeginEventHandler buildBegin = BuildBegin;
      ThreadHelper.ThrowIfNotOnUIThread();
      if (buildBegin != null)
      {
    ...
    {
      _dispBuildEvents_OnBuildDoneEventHandler buildDone = BuildDone;
      if (buildDone != null)
      {
    ...
    {
      _dispBuildEvents_OnBuildProjConfigBeginEventHandler buildProjConfigBegin = BuildProjConfigBegin;
    ...
    {
      _dispBuildEvents_OnBuildProjConfigDoneEventHandler buildProjConfigDone = BuildProjConfigDone;
