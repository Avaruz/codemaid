...
namespace ASGV.CodeMaid.Integration.Commands
{
    ...
    internal sealed class CleanupSelectedCodeCommand : BaseCommand
    {
        ...
        private IEnumerable<ProjectItem> SelectedProjectItems
        {
            get
            {
                ThreadHelper.ThrowIfNotOnUIThread(); return SolutionHelper.GetSelectedProjectItemsRecursively(Package).Where(x => CodeCleanupAvailabilityLogic.CanCleanupProjectItem(x));
            }
        }
        ...
        protected override void OnExecute()
        {
            ...
            {
                CleanupProgressViewModel viewModel = new(Package, SelectedProjectItems);
