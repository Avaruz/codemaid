...
namespace ASGV.CodeMaid.UI.Converters
{
    ...
    public class CodeItemToMetadataStringConverter : IValueConverter
    {
        ...
        {
            if (value is not BaseCodeItemElement codeItem)
            {
                return string.Empty;
            }
            ...
            try
            {
                ...
                return string.Join(", ", [.. metadataStrings.Distinct()]);
            }
            catch
            {
                return string.Empty;
        ...
        {
            List<string> strings = [.. GenerateMetadataStrings((BaseCodeItemElement)field)];
        ...
        {
            List<string> strings = [.. GenerateMetadataStrings((BaseCodeItemElement)method)];
